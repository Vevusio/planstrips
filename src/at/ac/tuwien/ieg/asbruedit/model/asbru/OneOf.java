...
public class OneOf {
    ...
    @XmlElement(name = "value-ref", required = true)
    protected List<ValueRef> valueRef;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the valueRef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getValueRef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ValueRef> getValueRef() {
        if (valueRef == null) {
            valueRef = new ArrayList<ValueRef>();
        }
