...
@XmlRootElement(name = "domain-defs")
public class DomainDefs {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "use-domain", type = UseDomain.class)
    })
    protected List<Object> domainOrUseDomain;
    ...
    /**
     * Gets the value of the domainOrUseDomain property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the domainOrUseDomain property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDomainOrUseDomain().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDomainOrUseDomain() {
        if (domainOrUseDomain == null) {
            domainOrUseDomain = new ArrayList<Object>();
        }
        return this.domainOrUseDomain;
    }
