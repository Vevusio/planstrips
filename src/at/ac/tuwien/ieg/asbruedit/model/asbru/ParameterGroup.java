...
public class ParameterGroup {
    ...
    @XmlElements({
        @XmlElement(name = "parameter-def", type = ParameterDef.class),
        @XmlElement(name = "parameter-group", type = ParameterGroup.class)
    })
    protected List<Object> parameterDefOrParameterGroup;
    ...
    /**
     * Gets the value of the parameterDefOrParameterGroup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the parameterDefOrParameterGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getParameterDefOrParameterGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getParameterDefOrParameterGroup() {
        if (parameterDefOrParameterGroup == null) {
            parameterDefOrParameterGroup = new ArrayList<Object>();
        }
        return this.parameterDefOrParameterGroup;
    }
