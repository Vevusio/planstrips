...
@XmlType(name = "", propOrder = {
    ...
    "allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot"
})
...
public class WaitFor {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "cardinality", required = true, type = Cardinality.class),
        ...
        @XmlElement(name = "static-plan-pointer", required = true, type = StaticPlanPointer.class),
        @XmlElement(name = "to-be-defined", required = true, type = ToBeDefined.class),
        @XmlElement(name = "wait-for-group", required = true, type = WaitForGroup.class),
        @XmlElement(name = "wait-for-not", required = true, type = WaitForNot.class)
    })
    protected List<Object> allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot;
    ...
    /**
     * Gets the value of the allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAllOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAllOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot() {
        if (allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot == null) {
            allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot = new ArrayList<Object>();
        }
        return this.allOrCardinalityOrNoneOrOneOrReferToOrStaticPlanPointerOrToBeDefinedOrWaitForGroupOrWaitForNot;
    }
