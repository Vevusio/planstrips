...
@XmlRootElement(name = "secondary-qualitative-entry")
public class SecondaryQualitativeEntry {
    ...
    @XmlElement(name = "based-on-entry", required = true)
    protected List<BasedOnEntry> basedOnEntry;
    ...
    /**
     * Gets the value of the basedOnEntry property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the basedOnEntry property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBasedOnEntry().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BasedOnEntry> getBasedOnEntry() {
        if (basedOnEntry == null) {
            basedOnEntry = new ArrayList<BasedOnEntry>();
        }
        return this.basedOnEntry;
    }
