...
@XmlRootElement(name = "intentions")
public class Intentions {
    ...
    protected List<Intention> intention;
    @XmlElement(name = "refer-to")
    protected List<ReferTo> referTo;
    ...
    public List<Intention> getIntention() {
        if (intention == null) {
            intention = new ArrayList<Intention>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the referTo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReferTo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ReferTo> getReferTo() {
        if (referTo == null) {
            referTo = new ArrayList<ReferTo>();
        }
        return this.referTo;
    }
