...
@XmlRootElement(name = "standard-deviation-def")
public class StandardDeviationDef {

    @XmlAttribute(name = "use-center-time")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String useCenterTime;
    @XmlElements({
    ...
    /**
     * Gets the value of the useCenterTime property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getUseCenterTime() {
        if (useCenterTime == null) {
            return "no";
        } else {
            return useCenterTime;
        }
    }

    /**
     * Sets the value of the useCenterTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setUseCenterTime(String value) {
        this.useCenterTime = value;
    }
