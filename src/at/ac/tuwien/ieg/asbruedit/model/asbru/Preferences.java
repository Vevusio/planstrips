...
public class Preferences {
    ...
    @XmlAttribute(name = "responsible-actor")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String responsibleActor;
    @XmlElements({
    ...
    @XmlElement(name = "resource-constraint")
    protected List<ResourceConstraint> resourceConstraint;
    protected List<Costs> costs;
    ...
    /**
     * Gets the value of the responsibleActor property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the responsibleActor property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setResponsibleActor(String value) {
        this.responsibleActor = value;
    }
     ...
     * 
     */
    public List<ResourceConstraint> getResourceConstraint() {
        if (resourceConstraint == null) {
            resourceConstraint = new ArrayList<ResourceConstraint>();
        }
