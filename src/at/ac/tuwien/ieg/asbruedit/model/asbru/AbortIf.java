...
@XmlType(name = "", propOrder = {
    ...
    "abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined"
})
@XmlRootElement(name = "abort-if")
public class AbortIf {
    ...
    protected List<Object> abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined;
    ...
    /**
     * Gets the value of the abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAbortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAbortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined() {
        if (abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined == null) {
            abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined = new ArrayList<Object>();
        }
        return this.abortIfGroupOrAbortIfItemOrAbortIfNotOrNoneOrReferToOrToBeDefined;
    }
