...
public class Returns {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "return-value", required = true, type = ReturnValue.class)
    })
    protected List<Object> planActivationOrReturnValue;
    ...
    /**
     * Gets the value of the planActivationOrReturnValue property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the planActivationOrReturnValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlanActivationOrReturnValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPlanActivationOrReturnValue() {
        if (planActivationOrReturnValue == null) {
            planActivationOrReturnValue = new ArrayList<Object>();
        }
        return this.planActivationOrReturnValue;
    }
