...
@XmlType(name = "", propOrder = {
    ...
    "episodeDefOrTimeWindowDef"
})
@XmlRootElement(name = "time-window-analysis-def")
public class TimeWindowAnalysisDef {
    ...
    protected List<Object> episodeDefOrTimeWindowDef;
    ...
    /**
     * Gets the value of the episodeDefOrTimeWindowDef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the episodeDefOrTimeWindowDef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEpisodeDefOrTimeWindowDef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getEpisodeDefOrTimeWindowDef() {
        if (episodeDefOrTimeWindowDef == null) {
            episodeDefOrTimeWindowDef = new ArrayList<Object>();
        }
        return this.episodeDefOrTimeWindowDef;
    }
