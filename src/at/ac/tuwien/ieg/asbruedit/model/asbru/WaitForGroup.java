...
@XmlType(name = "", propOrder = {
    ...
    "referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot"
})
@XmlRootElement(name = "wait-for-group")
public class WaitForGroup {
    ...
    protected List<Object> referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot;
    ...
    /**
     * Gets the value of the referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReferToOrStaticPlanPointerOrWaitForGroupOrWaitForNot().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getReferToOrStaticPlanPointerOrWaitForGroupOrWaitForNot() {
        if (referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot == null) {
            referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot = new ArrayList<Object>();
        }
        return this.referToOrStaticPlanPointerOrWaitForGroupOrWaitForNot;
    }
