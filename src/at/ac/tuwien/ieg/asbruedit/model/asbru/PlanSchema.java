...
@XmlRootElement(name = "plan-schema")
public class PlanSchema {
    ...
    @XmlElement(name = "argument-value")
    protected List<ArgumentValue> argumentValue;
    @XmlElement(name = "time-annotation")
    protected TimeAnnotation timeAnnotation;
    @XmlElement(name = "typical-duration")
    protected TypicalDuration typicalDuration;
    @XmlElement(name = "return-value-assignment")
    protected List<ReturnValueAssignment> returnValueAssignment;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the argumentValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getArgumentValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ArgumentValue> getArgumentValue() {
        if (argumentValue == null) {
            argumentValue = new ArrayList<ArgumentValue>();
        }
    ...
    /**
     * Gets the value of the typicalDuration property.
     * 
     * @return
     *     possible object is
     *     {@link TypicalDuration }
     *     
     */
    public TypicalDuration getTypicalDuration() {
        return typicalDuration;
    }

    /**
     * Sets the value of the typicalDuration property.
     * 
     * @param value
     *     allowed object is
     *     {@link TypicalDuration }
     *     
     */
    public void setTypicalDuration(TypicalDuration value) {
        this.typicalDuration = value;
    }

    /**
     * Gets the value of the returnValueAssignment property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the returnValueAssignment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReturnValueAssignment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ReturnValueAssignment }
     * 
     * 
     */
    public List<ReturnValueAssignment> getReturnValueAssignment() {
        if (returnValueAssignment == null) {
            returnValueAssignment = new ArrayList<ReturnValueAssignment>();
        }
        return this.returnValueAssignment;
    }
