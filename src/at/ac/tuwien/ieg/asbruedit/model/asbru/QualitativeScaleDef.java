...
@XmlType(name = "", propOrder = {
    ...
    "qualitativeEntry",
    "secondaryQualitativeEntry"
})
@XmlRootElement(name = "qualitative-scale-def")
public class QualitativeScaleDef {
    ...
    @XmlElement(name = "qualitative-entry", required = true)
    protected List<QualitativeEntry> qualitativeEntry;
    @XmlElement(name = "secondary-qualitative-entry")
    protected List<SecondaryQualitativeEntry> secondaryQualitativeEntry;
    ...
    /**
     * Gets the value of the qualitativeEntry property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the qualitativeEntry property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQualitativeEntry().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link QualitativeEntry }
     * 
     * 
     */
    public List<QualitativeEntry> getQualitativeEntry() {
        if (qualitativeEntry == null) {
            qualitativeEntry = new ArrayList<QualitativeEntry>();
        }
        return this.qualitativeEntry;
    }

    /**
     * Gets the value of the secondaryQualitativeEntry property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the secondaryQualitativeEntry property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSecondaryQualitativeEntry().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SecondaryQualitativeEntry }
     * 
     * 
     */
    public List<SecondaryQualitativeEntry> getSecondaryQualitativeEntry() {
        if (secondaryQualitativeEntry == null) {
            secondaryQualitativeEntry = new ArrayList<SecondaryQualitativeEntry>();
        }
        return this.secondaryQualitativeEntry;
    }
