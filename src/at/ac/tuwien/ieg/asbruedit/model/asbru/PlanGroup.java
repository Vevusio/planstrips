...
@XmlRootElement(name = "plan-group")
public class PlanGroup {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "plan-group", type = PlanGroup.class)
    })
    protected List<Object> planOrPlanGroup;
    ...
    /**
     * Gets the value of the planOrPlanGroup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the planOrPlanGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlanOrPlanGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPlanOrPlanGroup() {
        if (planOrPlanGroup == null) {
            planOrPlanGroup = new ArrayList<Object>();
        }
        return this.planOrPlanGroup;
    }
