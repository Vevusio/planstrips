...
@XmlRootElement(name = "patient-record-def")
public class PatientRecordDef {
    ...
    protected List<PrimaryKey> primaryKey;
    @XmlElement(name = "record-def", required = true)
    ...
    public List<PrimaryKey> getPrimaryKey() {
        if (primaryKey == null) {
            primaryKey = new ArrayList<PrimaryKey>();
        }
        return this.primaryKey;
    }

    /**
     * Gets the value of the recordDef property.
     * 
     * @return
     *     possible object is
     *     {@link RecordDef }
    ...
    /**
     * Sets the value of the recordDef property.
     * 
     * @param value
     *     allowed object is
     *     {@link RecordDef }
     *     
     */
    public void setRecordDef(RecordDef value) {
        this.recordDef = value;
    }
