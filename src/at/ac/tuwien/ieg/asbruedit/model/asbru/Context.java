...
@XmlType(name = "", propOrder = {
    ...
    "anyOrContextCombinationOrContextNotOrContextRefOrOneOf"
})
...
public class Context {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "context-combination", required = true, type = ContextCombination.class),
        @XmlElement(name = "context-not", required = true, type = ContextNot.class),
        @XmlElement(name = "context-ref", required = true, type = ContextRef.class),
        @XmlElement(name = "one-of", required = true, type = OneOf.class)
    })
    protected List<Object> anyOrContextCombinationOrContextNotOrContextRefOrOneOf;
    ...
    /**
     * Gets the value of the anyOrContextCombinationOrContextNotOrContextRefOrOneOf property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the anyOrContextCombinationOrContextNotOrContextRefOrOneOf property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAnyOrContextCombinationOrContextNotOrContextRefOrOneOf().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAnyOrContextCombinationOrContextNotOrContextRefOrOneOf() {
        if (anyOrContextCombinationOrContextNotOrContextRefOrOneOf == null) {
            anyOrContextCombinationOrContextNotOrContextRefOrOneOf = new ArrayList<Object>();
        }
        return this.anyOrContextCombinationOrContextNotOrContextRefOrOneOf;
    }
