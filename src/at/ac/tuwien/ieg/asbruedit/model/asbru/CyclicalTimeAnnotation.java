...
@XmlType(name = "", propOrder = {
    ...
    "timeRange",
    "cyclicalTimePointRefOrSetOfCyclicalTimePoints"
})
@XmlRootElement(name = "cyclical-time-annotation")
public class CyclicalTimeAnnotation {
    ...
    @XmlElements({
        @XmlElement(name = "cyclical-time-point-ref", required = true, type = CyclicalTimePointRef.class),
        @XmlElement(name = "set-of-cyclical-time-points", required = true, type = SetOfCyclicalTimePoints.class)
    })
    protected List<Object> cyclicalTimePointRefOrSetOfCyclicalTimePoints;
    ...
    /**
     * Gets the value of the cyclicalTimePointRefOrSetOfCyclicalTimePoints property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cyclicalTimePointRefOrSetOfCyclicalTimePoints property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCyclicalTimePointRefOrSetOfCyclicalTimePoints().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CyclicalTimePointRef }
     * {@link SetOfCyclicalTimePoints }
     * 
     * 
     */
    public List<Object> getCyclicalTimePointRefOrSetOfCyclicalTimePoints() {
        if (cyclicalTimePointRefOrSetOfCyclicalTimePoints == null) {
            cyclicalTimePointRefOrSetOfCyclicalTimePoints = new ArrayList<Object>();
        }
        return this.cyclicalTimePointRefOrSetOfCyclicalTimePoints;
    }
