...
@XmlRootElement(name = "setup-precondition")
public class SetupPrecondition {
    ...
    @XmlElement(name = "waiting-period")
    protected WaitingPeriod waitingPeriod;
     ...
     *     
     */
    public void setWaitingPeriod(WaitingPeriod value) {
