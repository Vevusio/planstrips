...
public class Plans {
    ...
    @XmlElement(name = "plan-group")
    protected List<PlanGroup> planGroup;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the planGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlanGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PlanGroup> getPlanGroup() {
        if (planGroup == null) {
            planGroup = new ArrayList<PlanGroup>();
        }
