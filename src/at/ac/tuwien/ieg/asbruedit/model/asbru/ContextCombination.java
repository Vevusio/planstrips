...
@XmlType(name = "", propOrder = {
    ...
    "contextCombinationOrContextNotOrContextRefOrOneOf"
})
@XmlRootElement(name = "context-combination")
public class ContextCombination {
    ...
    protected List<Object> contextCombinationOrContextNotOrContextRefOrOneOf;
    ...
    /**
     * Gets the value of the contextCombinationOrContextNotOrContextRefOrOneOf property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the contextCombinationOrContextNotOrContextRefOrOneOf property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContextCombinationOrContextNotOrContextRefOrOneOf().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getContextCombinationOrContextNotOrContextRefOrOneOf() {
        if (contextCombinationOrContextNotOrContextRefOrOneOf == null) {
            contextCombinationOrContextNotOrContextRefOrOneOf = new ArrayList<Object>();
        }
        return this.contextCombinationOrContextNotOrContextRefOrOneOf;
    }
