...
@XmlType(name = "", propOrder = {
    ...
    "episodeDefOrParameterRef"
})
@XmlRootElement(name = "episode-analysis-def")
public class EpisodeAnalysisDef {
    ...
    protected List<Object> episodeDefOrParameterRef;
    ...
    /**
     * Gets the value of the episodeDefOrParameterRef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the episodeDefOrParameterRef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEpisodeDefOrParameterRef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getEpisodeDefOrParameterRef() {
        if (episodeDefOrParameterRef == null) {
            episodeDefOrParameterRef = new ArrayList<Object>();
        }
        return this.episodeDefOrParameterRef;
    }
