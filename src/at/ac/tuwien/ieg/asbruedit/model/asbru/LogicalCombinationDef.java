...
@XmlType(name = "", propOrder = {
    ...
    "booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef"
})
@XmlRootElement(name = "logical-combination-def")
public class LogicalCombinationDef {
    ...
    protected List<Object> booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef;
    ...
    /**
     * Gets the value of the booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBooleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getBooleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef() {
        if (booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef == null) {
            booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef = new ArrayList<Object>();
        }
        return this.booleanDefOrComparisonDefOrLogicalCombinationDefOrParameterRefOrRawDataDef;
    }
