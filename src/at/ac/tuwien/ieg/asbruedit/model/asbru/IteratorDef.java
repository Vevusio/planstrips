...
@XmlType(name = "", propOrder = {
    ...
    "argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef"
})
@XmlRootElement(name = "iterator-def")
public class IteratorDef {
    ...
    protected java.util.List<Object> argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef;
    ...
    /**
     * Gets the value of the argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getArgumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public java.util.List<Object> getArgumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef() {
        if (argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef == null) {
            argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef = new ArrayList<Object>();
        }
        return this.argumentRefOrConstantRefOrFieldRefOrListOrMultiSetOrSetOrVariableRef;
    }
